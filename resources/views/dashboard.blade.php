...
<div class="hero-banner mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
    <div>
        <span class="text-xs fw-bold text-uppercase tracking-wider" style="color:#0f766e; letter-spacing:1.5px; font-size:0.75rem;">PANEL UTAMA SIM SEKOLAH</span>
        <h3 class="fw-bold mt-1 mb-2" style="color:#0f172a; font-family:'Outfit';">Selamat Datang, {{ Auth::user()->name }}! 👋</h3>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="card-custom p-3 d-flex align-items-center justify-content-between">
            <div>
                ...
                <h3 class="fw-bold m-0 mt-1" style="color:#0f172a;">{{ $stats['presensi_hadir'] }} <span class="fs-6 text-muted">/ {{ $stats['presensi_today'] }}</span></h3>
            </div>
...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-8">
        <div class="card-custom p-4 mb-4">
            <h5 class="fw-bold mb-3" style="color:#0f172a;"><i class="bi bi-lightning-charge-fill text-warning me-2"></i>Aksi Cepat Fitur</h5>
            <div class="row g-3">
                @role('Siswa')
        ...
        <div class="card-custom p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="fw-bold m-0" style="color:#0f172a;"><i class="bi bi-receipt me-2 text-primary"></i>Pengeluaran Talangan Terbaru (BendaharaKu)</h5>
                <a href="{{ route('expenses.index') }}" class="btn btn-sm btn-link text-decoration-none" style="color:#0f766e; font-weight:600;">Lihat Semua</a>
            </div>
    ...
    <div class="col-12 col-lg-4">
        <div class="card-custom p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="fw-bold m-0" style="color:#0f172a;"><i class="bi bi-clock-history me-2 text-warning"></i>Verifikasi SPP Pending</h5>
