    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle">
            <thead class="table-dark">
                <tr>
                    <th>No</th>
                    <th>Nama Tenant / Sekolah</th>
                    <th>Paket Berlangganan</th>
                    <th>Penggunaan Siswa</th>
                    <th>Masa Berlaku</th>
            ...
            <tbody>
                @forelse($tenants as $idx => $t)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="fw-semibold text-dark">{{ $totalSiswa }} Siswa</div>
                            <small class="text-muted">Batas: {{ $maxSiswa == 0 ? 'Unlimited' : $maxSiswa . ' Siswa' }}</small>
                        </td>
                        <td>
                        ...
                        <td class="text-center">
                            <div class="d-flex gap-1 justify-content-center">
                                <button class="btn btn-sm btn-primary rounded-3 fw-bold" data-bs-toggle="modal" data-bs-target="#assignPlanModal{{ $t->id }}">
                                    <i class="bi bi-gear-fill me-1"></i> Kelola Langganan
                                </button>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted py-4">Belum ada data tenant / sekolah terdaftar.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
